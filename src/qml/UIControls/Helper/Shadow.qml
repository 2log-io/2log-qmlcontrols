...
Item
{
    ...
    Rectangle
    {
        ...
        Gradient
        {
            ...
            GradientStop { position: 1.0; color: docroot.shadowColor }
        }
    }
    ...
    Rectangle
    {
        ...
        x: target.width - target.height / 2 + shadowSize/2 //(target.width/2) - (shadowSize/2) + 50 +4
        gradient:
        Gradient
        {
                GradientStop { position: 0.0; color: "transparent" }
    ...
    Rectangle
    {
        ...
        Gradient
        {
            ...
            GradientStop { position: 0.0; color: docroot.shadowColor }
        }
       rotation: 90
    }
